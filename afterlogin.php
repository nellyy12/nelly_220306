...
<div class="containerr">
  <h1 class="hi">FEATURED PRODUCTS</h1>
    ...
    <section class="services">
      ...
      <div class="container">
        <div class="service">
          <img src="indexx/images/coco.jpg" alt="Chanel" />
          <h2>Coco Chanel</h2>
          
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/dior.jpg" alt="Dior" />
          <h2>Dior</h2>
          
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/ely.jpg" alt="" />
          <h2>Elyess</h2>
          
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/gucci.jpg" alt="Gucci Items" />
          <h2>Gucci</h2>
          
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/lv.jpg" alt="Chanel" />
          <h2>Coco Chanel</h2>
          
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/versace.jpg" alt="Dior" />
          <h2>Dior</h2>
         
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/ari.jpg" alt="" />
          <h2>Elyess</h2>
         
          <p></p>
        </div>
        <div class="service">
          <img src="indexx/images/victo.jpg" alt="Gucci Items" />
          <h2>Gucci</h2>
